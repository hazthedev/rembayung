  ...
  return (
    <div className="min-h-screen bg-cream overflow-x-hidden">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 sm:px-6 lg:px-8" data-aos="fade-up" data-aos-delay="200">
          <h1 className="text-5xl md:text-7xl font-display text-white mb-6 drop-shadow-lg">
            Where Kampung Heritage
            <br />
            Meets Modern KL
          </h1>
          <div className="text-xl md:text-2xl text-white mb-8 drop-shadow-md max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="400">
            <p>
      ...
      <section id="about" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div data-aos="fade-right" data-aos-delay="200">
              <div>
                ...
                <div className="grid grid-cols-2 gap-6 mb-8">
                  <div className="flex items-center gap-3 p-4 bg-cream rounded-lg animate-slide-up" style={{animationDelay: '0.4s'}}>
                  ...
                  <div className="flex items-center gap-3 p-4 bg-cream rounded-lg animate-slide-up" style={{animationDelay: '0.5s'}}>
                ...
                <Button variant="outline" className="group animate-slide-left" style={{animationDelay: '0.6s'}}>
            ...
            <div className="relative h-[500px] rounded-lg overflow-hidden shadow-2xl group animate-slide-right" style={{animationDelay: '0.3s'}}>
              <Image
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={index}
                className={`overflow-hidden group hover:shadow-2xl transition-all duration-300 border-0 animate-slide-up`}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-forest/5">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-left" style={{animationDelay: '0.2s'}}>
              <div>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-4 p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow animate-slide-left" style={{animationDelay: '0.3s'}}>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow animate-slide-left" style={{animationDelay: '0.4s'}}>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow animate-slide-left" style={{animationDelay: '0.5s'}}>
                ...
                <Button className="shadow-lg hover:shadow-xl transition-shadow animate-slide-left" style={{animationDelay: '0.6s'}}>
            ...
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-2xl group animate-slide-right" style={{animationDelay: '0.3s'}}>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-primary text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center animate-slide-up" style={{animationDelay: '0.2s'}}>
          <h2 className="text-4xl font-display mb-6">
            Ready for an Authentic Kampung Experience?
          </h2>
          <div className="text-xl mb-8 opacity-90 animate-slide-up" style={{animationDelay: '0.3s'}}>
            <p>
